...
const c = require('./convertCSV')
const nn = require('./main')


const data = [[0.0139, 0.74, 0.835, 0, 10, 0.857, -3.425, 0, 0.0839, 123.024, 4, 0.535],
...
const weights = [0.139, 0.706, 0.679, 0.0000698, 9, 0.465, -5.614, 1, 0.0324, 140.081, 4, 0.657]

console.log("\n\n\n\nTODO: Your CPU supports instructions that this TensorFlow binary was not compiled to use: AVX2'")
console.log("WHAT DOES IT MEAN!?!?!?!?!\n\n\n")
// nn.perceptron(data[0], weights);

// for (var i in data){
//     // console.log('i:', data[i])

//     let a = tf.tensor1d(data[i])
